...
RUN sed -i.bak  's@/tools/Trimmomatic-0.38/trimmomatic-0.38.jar@/Trimmomatic-0.39/trimmomatic-0.39.jar@' -e 's@/tools/Trimmomatic-0.38/adapters/adapters.fa@/Trimmomatic-0.39/adapters/???@'   CLOMP/CLOMP.ini
